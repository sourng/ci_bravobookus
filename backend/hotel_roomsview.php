...
$hotel_rooms_view = NULL; // Initialize page object first

class chotel_rooms_view extends chotel_rooms {
	...
	// Page object name
	var $PageObjName = 'hotel_rooms_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "hotel_roomslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "hotel_roomslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($hotel_rooms_view)) $hotel_rooms_view = new chotel_rooms_view();

// Page init
$hotel_rooms_view->Page_Init();

// Page main
$hotel_rooms_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$hotel_rooms_view->Page_Render();
?>
...
var CurrentForm = fhotel_roomsview = new ew_Form("fhotel_roomsview", "view");

// Form_CustomValidate event
fhotel_roomsview.Form_CustomValidate = 
...
fhotel_roomsview.ValidateRequired = true;
<?php } else { ?>
fhotel_roomsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fhotel_roomsview.Lists["x_hr_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_roomsview.Lists["x_hr_status[]"].Options = <?php echo json_encode($hotel_rooms->hr_status->Options()) ?>;
...
<?php if ($hotel_rooms->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$hotel_rooms_view->IsModal) { ?>
<?php if ($hotel_rooms->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $hotel_rooms_view->ExportOptions->Render("body") ?>
<?php
	foreach ($hotel_rooms_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$hotel_rooms_view->IsModal) { ?>
<?php if ($hotel_rooms->Export == "") { ?>
...
<?php } ?>
<?php $hotel_rooms_view->ShowPageHeader(); ?>
<?php
$hotel_rooms_view->ShowMessage();
?>
<?php if (!$hotel_rooms_view->IsModal) { ?>
<?php if ($hotel_rooms->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($hotel_rooms_view->Pager)) $hotel_rooms_view->Pager = new cPrevNextPager($hotel_rooms_view->StartRec, $hotel_rooms_view->DisplayRecs, $hotel_rooms_view->TotalRecs) ?>
<?php if ($hotel_rooms_view->Pager->RecordCount > 0 && $hotel_rooms_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($hotel_rooms_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $hotel_rooms_view->PageUrl() ?>start=<?php echo $hotel_rooms_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($hotel_rooms_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $hotel_rooms_view->PageUrl() ?>start=<?php echo $hotel_rooms_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $hotel_rooms_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($hotel_rooms_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $hotel_rooms_view->PageUrl() ?>start=<?php echo $hotel_rooms_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($hotel_rooms_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $hotel_rooms_view->PageUrl() ?>start=<?php echo $hotel_rooms_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $hotel_rooms_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fhotel_roomsview" id="fhotel_roomsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($hotel_rooms_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $hotel_rooms_view->Token ?>">
<?php } ?>
...
<?php if ($hotel_rooms->hroom_id->Visible) { // hroom_id ?>
	<tr id="r_hroom_id">
		<td><span id="elh_hotel_rooms_hroom_id"><?php echo $hotel_rooms->hroom_id->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hroom_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hotel_id->Visible) { // hotel_id ?>
	<tr id="r_hotel_id">
		<td><span id="elh_hotel_rooms_hotel_id"><?php echo $hotel_rooms->hotel_id->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hotel_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->rt_id->Visible) { // rt_id ?>
	<tr id="r_rt_id">
		<td><span id="elh_hotel_rooms_rt_id"><?php echo $hotel_rooms->rt_id->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->rt_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_name->Visible) { // hr_name ?>
	<tr id="r_hr_name">
		<td><span id="elh_hotel_rooms_hr_name"><?php echo $hotel_rooms->hr_name->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hr_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_image->Visible) { // hr_image ?>
	<tr id="r_hr_image">
		<td><span id="elh_hotel_rooms_hr_image"><?php echo $hotel_rooms->hr_image->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hr_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_description->Visible) { // hr_description ?>
	<tr id="r_hr_description">
		<td><span id="elh_hotel_rooms_hr_description"><?php echo $hotel_rooms->hr_description->FldCaption() ?></span></td>
		<td data-name="hr_description"<?php echo $hotel_rooms->hr_description->CellAttributes() ?>>
<span id="el_hotel_rooms_hr_description">
<span<?php echo $hotel_rooms->hr_description->ViewAttributes() ?>>
<?php echo $hotel_rooms->hr_description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->amenities->Visible) { // amenities ?>
	<tr id="r_amenities">
		<td><span id="elh_hotel_rooms_amenities"><?php echo $hotel_rooms->amenities->FldCaption() ?></span></td>
		<td data-name="amenities"<?php echo $hotel_rooms->amenities->CellAttributes() ?>>
<span id="el_hotel_rooms_amenities">
<span<?php echo $hotel_rooms->amenities->ViewAttributes() ?>>
<?php echo $hotel_rooms->amenities->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_max->Visible) { // hr_max ?>
	<tr id="r_hr_max">
		<td><span id="elh_hotel_rooms_hr_max"><?php echo $hotel_rooms->hr_max->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hr_max->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_base_rate->Visible) { // hr_base_rate ?>
	<tr id="r_hr_base_rate">
		<td><span id="elh_hotel_rooms_hr_base_rate"><?php echo $hotel_rooms->hr_base_rate->FldCaption() ?></span></td>
...
<?php echo $hotel_rooms->hr_base_rate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_rooms->hr_status->Visible) { // hr_status ?>
	<tr id="r_hr_status">
		<td><span id="elh_hotel_rooms_hr_status"><?php echo $hotel_rooms->hr_status->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $hotel_rooms->hr_status->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotel_rooms->hr_status->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($hotel_rooms->Export == "") { ?>
<script type="text/javascript">
fhotel_roomsview.Init();
</script>
<?php } ?>
<?php
$hotel_rooms_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($hotel_rooms->Export == "") { ?>
...
<?php
$hotel_rooms_view->Page_Terminate();
?>
