...
class cservices_list extends cservices {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fserviceslistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
		...
		$sFilterList = ew_Concat($sFilterList, $this->service_name->AdvancedSearch->ToJSON(), ","); // Field service_name
		$sFilterList = ew_Concat($sFilterList, $this->service_desc->AdvancedSearch->ToJSON(), ","); // Field service_desc
		$sFilterList = ew_Concat($sFilterList, $this->service_icon->AdvancedSearch->ToJSON(), ","); // Field service_icon
		$sFilterList = ew_Concat($sFilterList, $this->service_image->AdvancedSearch->ToJSON(), ","); // Field service_image
		$sFilterList = ew_Concat($sFilterList, $this->service_link->AdvancedSearch->ToJSON(), ","); // Field service_link
	...
	function RestoreFilterList() {
		...
		// Field service_desc
		$this->service_desc->AdvancedSearch->SearchValue = @$filter["x_service_desc"];
		$this->service_desc->AdvancedSearch->SearchOperator = @$filter["z_service_desc"];
		$this->service_desc->AdvancedSearch->SearchCondition = @$filter["v_service_desc"];
		$this->service_desc->AdvancedSearch->SearchValue2 = @$filter["y_service_desc"];
		$this->service_desc->AdvancedSearch->SearchOperator2 = @$filter["w_service_desc"];
		$this->service_desc->AdvancedSearch->Save();
		...
		// Field service_image
		$this->service_image->AdvancedSearch->SearchValue = @$filter["x_service_image"];
		$this->service_image->AdvancedSearch->SearchOperator = @$filter["z_service_image"];
		$this->service_image->AdvancedSearch->SearchCondition = @$filter["v_service_image"];
		$this->service_image->AdvancedSearch->SearchValue2 = @$filter["y_service_image"];
		$this->service_image->AdvancedSearch->SearchOperator2 = @$filter["w_service_image"];
		$this->service_image->AdvancedSearch->Save();

		// Field service_link
		$this->service_link->AdvancedSearch->SearchValue = @$filter["x_service_link"];
		$this->service_link->AdvancedSearch->SearchOperator = @$filter["z_service_link"];
		$this->service_link->AdvancedSearch->SearchCondition = @$filter["v_service_link"];
		$this->service_link->AdvancedSearch->SearchValue2 = @$filter["y_service_link"];
		$this->service_link->AdvancedSearch->SearchOperator2 = @$filter["w_service_link"];
		$this->service_link->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->service_name, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->service_desc, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->service_icon, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->service_image, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->service_link, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->service_desc); // service_desc
			$this->UpdateSort($this->service_icon); // service_icon
			$this->UpdateSort($this->service_image); // service_image
			$this->UpdateSort($this->service_link); // service_link
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->service_desc->setSort("");
				$this->service_icon->setSort("");
				$this->service_image->setSort("");
				$this->service_link->setSort("");
				$this->status->setSort("");
			}
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fserviceslist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
...
<div class="panel panel-default ewGrid services">
<?php if ($services->Export == "") { ?>
...
<?php if ($services->service_name->Visible) { // service_name ?>
	<?php if ($services->SortUrl($services->service_name) == "") { ?>
		<th data-name="service_name"><div id="elh_services_service_name" class="services_service_name"><div class="ewTableHeaderCaption"><?php echo $services->service_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="service_name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->service_name) ?>',1);"><div id="elh_services_service_name" class="services_service_name">
...
<?php if ($services->service_desc->Visible) { // service_desc ?>
	<?php if ($services->SortUrl($services->service_desc) == "") { ?>
		<th data-name="service_desc"><div id="elh_services_service_desc" class="services_service_desc"><div class="ewTableHeaderCaption"><?php echo $services->service_desc->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="service_desc"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->service_desc) ?>',1);"><div id="elh_services_service_desc" class="services_service_desc">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->service_desc->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->service_desc->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->service_desc->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($services->service_icon->Visible) { // service_icon ?>
	...
	<?php } else { ?>
		<th data-name="service_icon"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->service_icon) ?>',1);"><div id="elh_services_service_icon" class="services_service_icon">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->service_icon->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->service_icon->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->service_icon->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($services->service_image->Visible) { // service_image ?>
	<?php if ($services->SortUrl($services->service_image) == "") { ?>
		<th data-name="service_image"><div id="elh_services_service_image" class="services_service_image"><div class="ewTableHeaderCaption"><?php echo $services->service_image->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="service_image"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->service_image) ?>',1);"><div id="elh_services_service_image" class="services_service_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->service_image->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->service_image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->service_image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($services->service_link->Visible) { // service_link ?>
	<?php if ($services->SortUrl($services->service_link) == "") { ?>
		<th data-name="service_link"><div id="elh_services_service_link" class="services_service_link"><div class="ewTableHeaderCaption"><?php echo $services->service_link->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="service_link"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->service_link) ?>',1);"><div id="elh_services_service_link" class="services_service_link">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->service_link->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->service_link->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->service_link->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<a id="<?php echo $services_list->PageObjName . "_row_" . $services_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($services->service_name->Visible) { // service_name ?>
		<td data-name="service_name"<?php echo $services->service_name->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_service_name" class="services_service_name">
...
<?php echo $services->service_name->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($services->service_desc->Visible) { // service_desc ?>
		<td data-name="service_desc"<?php echo $services->service_desc->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_service_desc" class="services_service_desc">
...
<?php echo $services->service_icon->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($services->service_image->Visible) { // service_image ?>
		<td data-name="service_image"<?php echo $services->service_image->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_service_image" class="services_service_image">
...
<?php echo $services->service_image->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($services->service_link->Visible) { // service_link ?>
		<td data-name="service_link"<?php echo $services->service_link->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_service_link" class="services_service_link">
