...
$selling_rooms_view = NULL; // Initialize page object first

class cselling_rooms_view extends cselling_rooms {
	...
	// Page object name
	var $PageObjName = 'selling_rooms_view';
	...
	function __construct() {
		...
		if (@$_GET["sell_room_id"] <> "") {
			$this->RecKey["sell_room_id"] = $_GET["sell_room_id"];
			$KeyUrl .= "&amp;sell_room_id=" . urlencode($this->RecKey["sell_room_id"]);
		}
		if (@$_GET["hroom_id"] <> "") {
		...
		if (@$_GET["rt_id"] <> "") {
			$this->RecKey["rt_id"] = $_GET["rt_id"];
			$KeyUrl .= "&amp;rt_id=" . urlencode($this->RecKey["rt_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["sell_room_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["sell_room_id"]);
		}
		if (@$_GET["hroom_id"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
		...
		if (@$_GET["rt_id"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["rt_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["sell_room_id"] <> "") {
				$this->sell_room_id->setFormValue($_POST["sell_room_id"]);
				$this->RecKey["sell_room_id"] = $this->sell_room_id->FormValue;
			} else {
			...
			if (@$_GET["rt_id"] <> "") {
				...
				$this->rt_id->setFormValue($_POST["rt_id"]);
				$this->RecKey["rt_id"] = $this->rt_id->FormValue;
			} else {
				$bLoadCurrentRecord = TRUE;
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "selling_roomslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "selling_roomslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($selling_rooms_view)) $selling_rooms_view = new cselling_rooms_view();

// Page init
$selling_rooms_view->Page_Init();

// Page main
$selling_rooms_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$selling_rooms_view->Page_Render();
?>
...
var CurrentForm = fselling_roomsview = new ew_Form("fselling_roomsview", "view");

// Form_CustomValidate event
fselling_roomsview.Form_CustomValidate = 
...
fselling_roomsview.ValidateRequired = true;
<?php } else { ?>
fselling_roomsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fselling_roomsview.Lists["x_room_sold[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fselling_roomsview.Lists["x_room_sold[]"].Options = <?php echo json_encode($selling_rooms->room_sold->Options()) ?>;
fselling_roomsview.Lists["x_room_closed[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fselling_roomsview.Lists["x_room_closed[]"].Options = <?php echo json_encode($selling_rooms->room_closed->Options()) ?>;
fselling_roomsview.Lists["x_room_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fselling_roomsview.Lists["x_room_status[]"].Options = <?php echo json_encode($selling_rooms->room_status->Options()) ?>;
...
<?php if ($selling_rooms->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$selling_rooms_view->IsModal) { ?>
<?php if ($selling_rooms->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $selling_rooms_view->ExportOptions->Render("body") ?>
<?php
	foreach ($selling_rooms_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$selling_rooms_view->IsModal) { ?>
<?php if ($selling_rooms->Export == "") { ?>
...
<?php } ?>
<?php $selling_rooms_view->ShowPageHeader(); ?>
<?php
$selling_rooms_view->ShowMessage();
?>
<?php if (!$selling_rooms_view->IsModal) { ?>
<?php if ($selling_rooms->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($selling_rooms_view->Pager)) $selling_rooms_view->Pager = new cPrevNextPager($selling_rooms_view->StartRec, $selling_rooms_view->DisplayRecs, $selling_rooms_view->TotalRecs) ?>
<?php if ($selling_rooms_view->Pager->RecordCount > 0 && $selling_rooms_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($selling_rooms_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $selling_rooms_view->PageUrl() ?>start=<?php echo $selling_rooms_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($selling_rooms_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $selling_rooms_view->PageUrl() ?>start=<?php echo $selling_rooms_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $selling_rooms_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($selling_rooms_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $selling_rooms_view->PageUrl() ?>start=<?php echo $selling_rooms_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($selling_rooms_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $selling_rooms_view->PageUrl() ?>start=<?php echo $selling_rooms_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $selling_rooms_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fselling_roomsview" id="fselling_roomsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($selling_rooms_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $selling_rooms_view->Token ?>">
<?php } ?>
...
<?php if ($selling_rooms->sell_room_id->Visible) { // sell_room_id ?>
	<tr id="r_sell_room_id">
		<td><span id="elh_selling_rooms_sell_room_id"><?php echo $selling_rooms->sell_room_id->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->sell_room_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->hroom_id->Visible) { // hroom_id ?>
	<tr id="r_hroom_id">
		<td><span id="elh_selling_rooms_hroom_id"><?php echo $selling_rooms->hroom_id->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->hroom_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->hotel_id->Visible) { // hotel_id ?>
	<tr id="r_hotel_id">
		<td><span id="elh_selling_rooms_hotel_id"><?php echo $selling_rooms->hotel_id->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->hotel_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->rt_id->Visible) { // rt_id ?>
	<tr id="r_rt_id">
		<td><span id="elh_selling_rooms_rt_id"><?php echo $selling_rooms->rt_id->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->rt_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->sell_date->Visible) { // sell_date ?>
	<tr id="r_sell_date">
		<td><span id="elh_selling_rooms_sell_date"><?php echo $selling_rooms->sell_date->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->sell_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->day->Visible) { // day ?>
	<tr id="r_day">
		<td><span id="elh_selling_rooms_day"><?php echo $selling_rooms->day->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->day->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->month->Visible) { // month ?>
	<tr id="r_month">
		<td><span id="elh_selling_rooms_month"><?php echo $selling_rooms->month->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->month->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->year->Visible) { // year ?>
	<tr id="r_year">
		<td><span id="elh_selling_rooms_year"><?php echo $selling_rooms->year->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->year->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->max_people->Visible) { // max_people ?>
	<tr id="r_max_people">
		<td><span id="elh_selling_rooms_max_people"><?php echo $selling_rooms->max_people->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->max_people->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->base_rate->Visible) { // base_rate ?>
	<tr id="r_base_rate">
		<td><span id="elh_selling_rooms_base_rate"><?php echo $selling_rooms->base_rate->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->base_rate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->discount->Visible) { // discount ?>
	<tr id="r_discount">
		<td><span id="elh_selling_rooms_discount"><?php echo $selling_rooms->discount->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->discount->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->room_sell->Visible) { // room_sell ?>
	<tr id="r_room_sell">
		<td><span id="elh_selling_rooms_room_sell"><?php echo $selling_rooms->room_sell->FldCaption() ?></span></td>
...
<?php echo $selling_rooms->room_sell->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($selling_rooms->room_sold->Visible) { // room_sold ?>
	<tr id="r_room_sold">
		<td><span id="elh_selling_rooms_room_sold"><?php echo $selling_rooms->room_sold->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $selling_rooms->room_sold->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $selling_rooms->room_sold->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($selling_rooms->room_closed->Visible) { // room_closed ?>
	<tr id="r_room_closed">
		<td><span id="elh_selling_rooms_room_closed"><?php echo $selling_rooms->room_closed->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $selling_rooms->room_closed->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $selling_rooms->room_closed->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($selling_rooms->room_status->Visible) { // room_status ?>
	<tr id="r_room_status">
		<td><span id="elh_selling_rooms_room_status"><?php echo $selling_rooms->room_status->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $selling_rooms->room_status->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $selling_rooms->room_status->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($selling_rooms->Export == "") { ?>
<script type="text/javascript">
fselling_roomsview.Init();
</script>
<?php } ?>
<?php
$selling_rooms_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($selling_rooms->Export == "") { ?>
...
<?php
$selling_rooms_view->Page_Terminate();
?>
