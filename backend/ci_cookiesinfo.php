...
//
// Table class for ci_cookies
//
class cci_cookies extends cTable {
	var $id;
	var $cookie_id;
	var $netid;
	var $ip_address;
	var $user_agent;
	var $orig_page_requested;
	var $php_session_id;
	var $created_at;
	var $updated_at;
	...
	function __construct() {
		...
		$this->TableVar = 'ci_cookies';
		$this->TableName = 'ci_cookies';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ci_cookies`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('ci_cookies', 'ci_cookies', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// cookie_id
		$this->cookie_id = new cField('ci_cookies', 'ci_cookies', 'x_cookie_id', 'cookie_id', '`cookie_id`', '`cookie_id`', 200, -1, FALSE, '`cookie_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cookie_id->Sortable = TRUE; // Allow sort
		$this->fields['cookie_id'] = &$this->cookie_id;

		// netid
		$this->netid = new cField('ci_cookies', 'ci_cookies', 'x_netid', 'netid', '`netid`', '`netid`', 200, -1, FALSE, '`netid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->netid->Sortable = TRUE; // Allow sort
		$this->fields['netid'] = &$this->netid;

		// ip_address
		$this->ip_address = new cField('ci_cookies', 'ci_cookies', 'x_ip_address', 'ip_address', '`ip_address`', '`ip_address`', 200, -1, FALSE, '`ip_address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ip_address->Sortable = TRUE; // Allow sort
		$this->fields['ip_address'] = &$this->ip_address;

		// user_agent
		$this->user_agent = new cField('ci_cookies', 'ci_cookies', 'x_user_agent', 'user_agent', '`user_agent`', '`user_agent`', 200, -1, FALSE, '`user_agent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_agent->Sortable = TRUE; // Allow sort
		$this->fields['user_agent'] = &$this->user_agent;

		// orig_page_requested
		$this->orig_page_requested = new cField('ci_cookies', 'ci_cookies', 'x_orig_page_requested', 'orig_page_requested', '`orig_page_requested`', '`orig_page_requested`', 200, -1, FALSE, '`orig_page_requested`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->orig_page_requested->Sortable = TRUE; // Allow sort
		$this->fields['orig_page_requested'] = &$this->orig_page_requested;

		// php_session_id
		$this->php_session_id = new cField('ci_cookies', 'ci_cookies', 'x_php_session_id', 'php_session_id', '`php_session_id`', '`php_session_id`', 200, -1, FALSE, '`php_session_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->php_session_id->Sortable = TRUE; // Allow sort
		$this->fields['php_session_id'] = &$this->php_session_id;

		// created_at
		$this->created_at = new cField('ci_cookies', 'ci_cookies', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = TRUE; // Allow sort
		$this->created_at->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('ci_cookies', 'ci_cookies', 'x_updated_at', 'updated_at', '`updated_at`', ew_CastDateFieldForLike('`updated_at`', 0, "DB"), 135, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ci_cookies`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ci_cookiesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ci_cookiesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ci_cookiesadd.php?" . $this->UrlParm($parm);
		else
			$url = "ci_cookiesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ci_cookiesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ci_cookiesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ci_cookiesdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->cookie_id->EditValue = $this->cookie_id->CurrentValue;
		...
		$this->orig_page_requested->EditValue = $this->orig_page_requested->CurrentValue;
		...
		$this->php_session_id->EditValue = $this->php_session_id->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->cookie_id->Exportable) $Doc->ExportCaption($this->cookie_id);
					if ($this->netid->Exportable) $Doc->ExportCaption($this->netid);
					...
					if ($this->orig_page_requested->Exportable) $Doc->ExportCaption($this->orig_page_requested);
					if ($this->php_session_id->Exportable) $Doc->ExportCaption($this->php_session_id);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->cookie_id->Exportable) $Doc->ExportField($this->cookie_id);
						if ($this->netid->Exportable) $Doc->ExportField($this->netid);
						...
						if ($this->orig_page_requested->Exportable) $Doc->ExportField($this->orig_page_requested);
						if ($this->php_session_id->Exportable) $Doc->ExportField($this->php_session_id);
