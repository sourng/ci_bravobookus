	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["uid"] <> "") {
				...
				$this->uid->setFormValue($_POST["uid"]);
				$this->RecKey["uid"] = $this->uid->FormValue;
			} else {
...
<?php if ($users->unique_id->Visible) { // unique_id ?>
	<tr id="r_unique_id">
		<td><span id="elh_users_unique_id"><?php echo $users->unique_id->FldCaption() ?></span></td>
...
<?php echo $users->unique_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($users->encrypted_password->Visible) { // encrypted_password ?>
	<tr id="r_encrypted_password">
		<td><span id="elh_users_encrypted_password"><?php echo $users->encrypted_password->FldCaption() ?></span></td>
...
<?php echo $users->encrypted_password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($users->note->Visible) { // note ?>
	<tr id="r_note">
		<td><span id="elh_users_note"><?php echo $users->note->FldCaption() ?></span></td>
		<td data-name="note"<?php echo $users->note->CellAttributes() ?>>
<span id="el_users_note">
<span<?php echo $users->note->ViewAttributes() ?>>
<?php echo $users->note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->user_create->Visible) { // user_create ?>
	<tr id="r_user_create">
		<td><span id="elh_users_user_create"><?php echo $users->user_create->FldCaption() ?></span></td>
...
<?php echo $users->user_create->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_users_created_date"><?php echo $users->created_date->FldCaption() ?></span></td>
...
<?php echo $users->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->user_update->Visible) { // user_update ?>
	<tr id="r_user_update">
		<td><span id="elh_users_user_update"><?php echo $users->user_update->FldCaption() ?></span></td>
...
<?php echo $users->user_update->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->updated_date->Visible) { // updated_date ?>
	<tr id="r_updated_date">
		<td><span id="elh_users_updated_date"><?php echo $users->updated_date->FldCaption() ?></span></td>
...
<?php echo $users->updated_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_users_image"><?php echo $users->image->FldCaption() ?></span></td>
