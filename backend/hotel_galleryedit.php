...
$hotel_gallery_edit = NULL; // Initialize page object first

class chotel_gallery_edit extends chotel_gallery {
	...
	// Page object name
	var $PageObjName = 'hotel_gallery_edit';
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->hgallery_id->FldIsDetailKey)
			$this->hgallery_id->setFormValue($objForm->GetValue("x_hgallery_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->hgallery_id->CurrentValue = $this->hgallery_id->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->hg_img1->SetDbValueDef($rsnew, $this->hg_img1->CurrentValue, NULL, $this->hg_img1->ReadOnly);

			// hg_img2
			$this->hg_img2->SetDbValueDef($rsnew, $this->hg_img2->CurrentValue, NULL, $this->hg_img2->ReadOnly);

			// hg_img3
			$this->hg_img3->SetDbValueDef($rsnew, $this->hg_img3->CurrentValue, NULL, $this->hg_img3->ReadOnly);

			// hg_img4
			$this->hg_img4->SetDbValueDef($rsnew, $this->hg_img4->CurrentValue, NULL, $this->hg_img4->ReadOnly);

			// hg_img5
			$this->hg_img5->SetDbValueDef($rsnew, $this->hg_img5->CurrentValue, NULL, $this->hg_img5->ReadOnly);

			// hg_img6
			$this->hg_img6->SetDbValueDef($rsnew, $this->hg_img6->CurrentValue, NULL, $this->hg_img6->ReadOnly);

			// hg_img7
			$this->hg_img7->SetDbValueDef($rsnew, $this->hg_img7->CurrentValue, NULL, $this->hg_img7->ReadOnly);

			// hg_img8
			$this->hg_img8->SetDbValueDef($rsnew, $this->hg_img8->CurrentValue, NULL, $this->hg_img8->ReadOnly);

			// hg_img9
			$this->hg_img9->SetDbValueDef($rsnew, $this->hg_img9->CurrentValue, NULL, $this->hg_img9->ReadOnly);

			// hg_img10
			$this->hg_img10->SetDbValueDef($rsnew, $this->hg_img10->CurrentValue, NULL, $this->hg_img10->ReadOnly);

			// hg_img11
			$this->hg_img11->SetDbValueDef($rsnew, $this->hg_img11->CurrentValue, NULL, $this->hg_img11->ReadOnly);

			// hg_img12
			$this->hg_img12->SetDbValueDef($rsnew, $this->hg_img12->CurrentValue, NULL, $this->hg_img12->ReadOnly);

			// hg_img13
			$this->hg_img13->SetDbValueDef($rsnew, $this->hg_img13->CurrentValue, NULL, $this->hg_img13->ReadOnly);

			// hg_img14
			$this->hg_img14->SetDbValueDef($rsnew, $this->hg_img14->CurrentValue, NULL, $this->hg_img14->ReadOnly);

			// hg_img15
			$this->hg_img15->SetDbValueDef($rsnew, $this->hg_img15->CurrentValue, NULL, $this->hg_img15->ReadOnly);

			// hg_img16
			$this->hg_img16->SetDbValueDef($rsnew, $this->hg_img16->CurrentValue, NULL, $this->hg_img16->ReadOnly);

			// hg_img17
			$this->hg_img17->SetDbValueDef($rsnew, $this->hg_img17->CurrentValue, NULL, $this->hg_img17->ReadOnly);

			// hg_img18
			$this->hg_img18->SetDbValueDef($rsnew, $this->hg_img18->CurrentValue, NULL, $this->hg_img18->ReadOnly);

			// hg_img19
			$this->hg_img19->SetDbValueDef($rsnew, $this->hg_img19->CurrentValue, NULL, $this->hg_img19->ReadOnly);

			// hg_img20
			$this->hg_img20->SetDbValueDef($rsnew, $this->hg_img20->CurrentValue, NULL, $this->hg_img20->ReadOnly);

			// hg_img21
			$this->hg_img21->SetDbValueDef($rsnew, $this->hg_img21->CurrentValue, NULL, $this->hg_img21->ReadOnly);

			// hg_img22
			$this->hg_img22->SetDbValueDef($rsnew, $this->hg_img22->CurrentValue, NULL, $this->hg_img22->ReadOnly);

			// hg_img23
			$this->hg_img23->SetDbValueDef($rsnew, $this->hg_img23->CurrentValue, NULL, $this->hg_img23->ReadOnly);

			// hg_img24
			$this->hg_img24->SetDbValueDef($rsnew, $this->hg_img24->CurrentValue, NULL, $this->hg_img24->ReadOnly);

			// last_update
			$this->last_update->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->last_update->CurrentValue, 0), NULL, $this->last_update->ReadOnly);
...
// Create page object
if (!isset($hotel_gallery_edit)) $hotel_gallery_edit = new chotel_gallery_edit();

// Page init
$hotel_gallery_edit->Page_Init();

// Page main
$hotel_gallery_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$hotel_gallery_edit->Page_Render();
?>
...
var CurrentForm = fhotel_galleryedit = new ew_Form("fhotel_galleryedit", "edit");

// Validate form
fhotel_galleryedit.Validate = function() {
...
fhotel_galleryedit.Form_CustomValidate = 
...
fhotel_galleryedit.ValidateRequired = true;
<?php } else { ?>
fhotel_galleryedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$hotel_gallery_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $hotel_gallery_edit->ShowPageHeader(); ?>
<?php
$hotel_gallery_edit->ShowMessage();
?>
<?php if (!$hotel_gallery_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($hotel_gallery_edit->Pager)) $hotel_gallery_edit->Pager = new cPrevNextPager($hotel_gallery_edit->StartRec, $hotel_gallery_edit->DisplayRecs, $hotel_gallery_edit->TotalRecs) ?>
<?php if ($hotel_gallery_edit->Pager->RecordCount > 0 && $hotel_gallery_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($hotel_gallery_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $hotel_gallery_edit->PageUrl() ?>start=<?php echo $hotel_gallery_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($hotel_gallery_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $hotel_gallery_edit->PageUrl() ?>start=<?php echo $hotel_gallery_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $hotel_gallery_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($hotel_gallery_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $hotel_gallery_edit->PageUrl() ?>start=<?php echo $hotel_gallery_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($hotel_gallery_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $hotel_gallery_edit->PageUrl() ?>start=<?php echo $hotel_gallery_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $hotel_gallery_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fhotel_galleryedit" id="fhotel_galleryedit" class="<?php echo $hotel_gallery_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($hotel_gallery_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $hotel_gallery_edit->Token ?>">
<?php } ?>
...
<?php if ($hotel_gallery->hgallery_id->Visible) { // hgallery_id ?>
	<div id="r_hgallery_id" class="form-group">
		<label id="elh_hotel_gallery_hgallery_id" class="col-sm-2 control-label ewLabel"><?php echo $hotel_gallery->hgallery_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $hotel_gallery->hgallery_id->CellAttributes() ?>>
<span id="el_hotel_gallery_hgallery_id">
<span<?php echo $hotel_gallery->hgallery_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $hotel_gallery->hgallery_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="hotel_gallery" data-field="x_hgallery_id" name="x_hgallery_id" id="x_hgallery_id" value="<?php echo ew_HtmlEncode($hotel_gallery->hgallery_id->CurrentValue) ?>">
<?php echo $hotel_gallery->hgallery_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<p class="form-control-static"><?php echo $hotel_gallery->hotel_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="hotel_gallery" data-field="x_hotel_id" name="x_hotel_id" id="x_hotel_id" value="<?php echo ew_HtmlEncode($hotel_gallery->hotel_id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $hotel_gallery_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($hotel_gallery_edit->Pager)) $hotel_gallery_edit->Pager = new cPrevNextPager($hotel_gallery_edit->StartRec, $hotel_gallery_edit->DisplayRecs, $hotel_gallery_edit->TotalRecs) ?>
<?php if ($hotel_gallery_edit->Pager->RecordCount > 0 && $hotel_gallery_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fhotel_galleryedit.Init();
</script>
<?php
$hotel_gallery_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$hotel_gallery_edit->Page_Terminate();
?>
