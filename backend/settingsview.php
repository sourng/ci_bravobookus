...
class csettings_view extends csettings {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["setting_id"] <> "") {
				$this->setting_id->setFormValue($_POST["setting_id"]);
...
<?php if ($settings_view->Pager->RecordCount > 0 && $settings_view->Pager->Visible) { ?>
<div class="ewPager">
...
<?php if ($settings->setting_id->Visible) { // setting_id ?>
	<tr id="r_setting_id">
		<td><span id="elh_settings_setting_id"><?php echo $settings->setting_id->FldCaption() ?></span></td>
...
<?php echo $settings->setting_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->site_name->Visible) { // site_name ?>
	<tr id="r_site_name">
		<td><span id="elh_settings_site_name"><?php echo $settings->site_name->FldCaption() ?></span></td>
...
<?php echo $settings->site_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->logo->Visible) { // logo ?>
	<tr id="r_logo">
		<td><span id="elh_settings_logo"><?php echo $settings->logo->FldCaption() ?></span></td>
		<td data-name="logo"<?php echo $settings->logo->CellAttributes() ?>>
<span id="el_settings_logo">
<span>
<?php echo ew_GetFileViewTag($settings->logo, $settings->logo->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($settings->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_settings_phone"><?php echo $settings->phone->FldCaption() ?></span></td>
...
<?php echo $settings->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($settings->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_settings__email"><?php echo $settings->_email->FldCaption() ?></span></td>
...
<?php echo $settings->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_settings_address"><?php echo $settings->address->FldCaption() ?></span></td>
...
<?php echo $settings->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->note->Visible) { // note ?>
	<tr id="r_note">
		<td><span id="elh_settings_note"><?php echo $settings->note->FldCaption() ?></span></td>
...
<?php echo $settings->note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->facebook->Visible) { // facebook ?>
	<tr id="r_facebook">
		<td><span id="elh_settings_facebook"><?php echo $settings->facebook->FldCaption() ?></span></td>
...
<?php echo $settings->facebook->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->twitter->Visible) { // twitter ?>
	<tr id="r_twitter">
		<td><span id="elh_settings_twitter"><?php echo $settings->twitter->FldCaption() ?></span></td>
...
<?php echo $settings->twitter->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->gplus->Visible) { // gplus ?>
	<tr id="r_gplus">
		<td><span id="elh_settings_gplus"><?php echo $settings->gplus->FldCaption() ?></span></td>
...
<?php echo $settings->gplus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->youtube->Visible) { // youtube ?>
	<tr id="r_youtube">
		<td><span id="elh_settings_youtube"><?php echo $settings->youtube->FldCaption() ?></span></td>
...
<?php echo $settings->youtube->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->linkin->Visible) { // linkin ?>
	<tr id="r_linkin">
		<td><span id="elh_settings_linkin"><?php echo $settings->linkin->FldCaption() ?></span></td>
...
<?php echo $settings->linkin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
