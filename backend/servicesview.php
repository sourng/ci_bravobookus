...
class cservices_view extends cservices {
	...
	function Page_Init() {
		...
		if (@$_GET["service_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["service_id"]);
		}
...
<?php if ($services_view->Pager->RecordCount > 0 && $services_view->Pager->Visible) { ?>
<div class="ewPager">
...
<?php if ($services->service_name->Visible) { // service_name ?>
	<tr id="r_service_name">
		<td><span id="elh_services_service_name"><?php echo $services->service_name->FldCaption() ?></span></td>
...
<?php echo $services->service_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->service_desc->Visible) { // service_desc ?>
	<tr id="r_service_desc">
		<td><span id="elh_services_service_desc"><?php echo $services->service_desc->FldCaption() ?></span></td>
...
<?php echo $services->service_desc->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($services->service_image->Visible) { // service_image ?>
	<tr id="r_service_image">
		<td><span id="elh_services_service_image"><?php echo $services->service_image->FldCaption() ?></span></td>
...
<?php echo $services->service_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->service_link->Visible) { // service_link ?>
	<tr id="r_service_link">
		<td><span id="elh_services_service_link"><?php echo $services->service_link->FldCaption() ?></span></td>
...
<?php echo $services->service_link->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
